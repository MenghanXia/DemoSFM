...
{
public:
	Triangulation(Mat_<double> intrinsicMat,Size imgSize_,vector<frameInfo> *frameList_,vector<cloudPoint> *objectClouds_)
	{
		K = intrinsicMat;
		imgSize = imgSize_;
		sumOutlier = 0;
	...
	double meanReprojectError(int start, int end, double sampleRate);
